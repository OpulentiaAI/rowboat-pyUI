...
export const starting_copilot_prompts: { [key: string]: string } = {
    ...
    "Gemini AI Assistant": "Create a helpful AI assistant powered by Google's Gemini model (gemini-1.5-flash) that can answer questions, provide explanations, help with creative writing, and assist with various tasks. The assistant should be knowledgeable, accurate, and maintain a friendly and professional tone.",

    "Advanced Coding Assistant": "Create an advanced coding assistant powered by Google's latest Gemini 2.5 Pro Preview model (gemini-2.5-pro-preview-05-06). This assistant excels at complex reasoning, code generation, debugging, architecture design, and multimodal understanding. Perfect for software development, code reviews, and technical problem solving.",
}